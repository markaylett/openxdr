...
xdr_float(XDR *xdrs, float *fp)
{
	...
	case XDR_ENCODE:
        /* RFC 1013: According to IEEE specifications, the "NaN" (not a
...
# endif /* !WORDS_BIGENDIAN */
	...
	shipit:
        ...
        /*
         * If either operand is a double, the other operand is converted to
         * double.
         */
